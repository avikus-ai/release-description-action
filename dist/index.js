...
if (!globalThis.ReadableStream) {
  ...
  try {
    ...
    Object.assign(globalThis, __nccwpck_require__(219))
  }
}
...
/* harmony import */ var _actions_core__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(626);
/* harmony import */ var node_fetch__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(261);
...
async function getReleatedIssues() {
  const response = await (0,node_fetch__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .ZP)(
    `https://avikus.atlassian.net/rest/api/2/search?jql=project=${projectKey}+AND+fixVersion=${version}+ORDER+BY+type+ASC&fields=summary&fields=issuetype`,
    {
      method: "GET",
      headers: {
...
const { issues } = await getReleatedIssues();
...
_actions_core__WEBPACK_IMPORTED_MODULE_0__.setOutput("content", content);
...
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(333);
...
var node_domexception = __nccwpck_require__(534);
// EXTERNAL MODULE: ./node_modules/fetch-blob/file.js
var file = __nccwpck_require__(480);
// EXTERNAL MODULE: ./node_modules/fetch-blob/index.js
var fetch_blob = __nccwpck_require__(333);
...
/* harmony import */ var _streams_cjs__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(624);
...
/* harmony export */ });
/* unused harmony export File */
/* harmony import */ var fetch_blob__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(333);
/* harmony import */ var fetch_blob_file_js__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(480);
...
var esm_min = __nccwpck_require__(584);
...
class Body {
	...
	async formData() {
		...
		const {toFormData} = await __nccwpck_require__.e(/* import() */ 54).then(__nccwpck_require__.bind(__nccwpck_require__, 54));
...
var from = __nccwpck_require__(778);
